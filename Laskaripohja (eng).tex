...
\usepackage{datetime} %muuttaa today-komennon muotoilua
...
\firstpageheader{[NAME OF THE COURSE]\\	%headerin vasen laita
					Spring/Fall 20XX\\
					Exercise X} %HARJOITUKSEN NUMERO!
					{}								%headerin keskiosa
					{Name: Olli Väisänen\\			%headerin oikea laita
					e-mail: \email \\
					Student id: XXXXXX}
\firstpageheadrule
...
%Exercise X \hfill  Student id: XXXXXXXX \\%HARJOITUKSEN NUMERO!
